...
async function botCraftOnce(bot, config) {
    ...
    for (let i in recipe.delta) {
        ...
        let withdrawAmount = (-(recipeItem.count * 1)) - amountInInventory;  // 8 ta netherite ingot uchun hisoblash
        if (withdrawAmount > 0) {
    ...
    let craftingAmount = 1;  // 8 ta netherite ingotni crafting qilish
